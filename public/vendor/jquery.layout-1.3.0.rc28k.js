/*
 * jquery.layout 1.3.0 - Release Candidate 28k (MODIFIED VERSION)
 *
 * Copyright (c) 2010 
 ...
 *
 * $Date: 2010-05-15 08:00:00 (Sat, 15 May 2010) $
 * $Rev: 3028 $
 * 
 ...
 */
	...
	var initOptions = function () {
		...
		$.each("paneClass,contentSelector,applyDemoStyles,showOverflowOnHover,triggerEventsOnLoad,resizeContentWhileDragging".split(","),
 ...
 */
	...
	var sizeContent = function (panes) {
		...
		$.each(panes.split(","), function (idx, pane) {
			...
			if (o.resizeContentWhileDragging || !_c.isLayoutBusy || m.above == undefined) {
				var
